...
public class Topic
{
	...
	{
		return "Topic [topic_base_word=" + topic_base_word + ", bookName=" + bookName + ", topic_id=" + topic_id + ", matched_word=" + matched_word + ", mean_cn=" + mean_cn + ", state=" + state + "]";
	}
	...
	public int hashCode()
	{
		final int prime = 31;
		int result = 1;
		result = prime * result + ((matched_word == null) ? 0 : matched_word.toLowerCase().hashCode());
		return result;
	}
