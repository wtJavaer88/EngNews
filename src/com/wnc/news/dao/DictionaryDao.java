...
public class DictionaryDao
{
	...
	public synchronized static DicWord findWord(String word)
	{
		...
		try
		{
			...
			String sql = "select e.*,d.topic_word,d.mean_cn FROM  dictionary D LEFT JOIN word_exchange E  ON E.topic_id=D.topic_id where topic_word='" + word + "' or  word_third='" + word + "' or  word_done='" + word + "' or  word_er='" + word + "' or  word_est='" + word
					+ "' or  word_ing='" + word + "' or  word_pl='" + word + "' or  word_past='" + word + "'";
			...
			while (!c.isAfterLast())
			{
				...
				dicWord.setWord_third(c.getString(c.getColumnIndex("word_third")));
