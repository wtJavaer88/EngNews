...
public class WebSiteUtil
{
	...
	public static WebSite getRealGm()
	{
		...
		{
			squawka = new WebSite();
			squawka.setName("realgm");
			squawka.setDb_id("4");
			squawka.setNews_class("#page-body content");
			squawka.setMain_div(".inner .row");
			squawka.setFormat("http://forums.realgm.com/boards/viewforum.php?f=6&start=%d");
		}
		return squawka;
	}
