...
public class NewsContentActivity extends Activity implements UncaughtExceptionHandler
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		if (getIntent() != null && getIntent().hasExtra("news_url") && getIntent().hasExtra("news_class"))
		{
			...
			if (BasicStringUtil.isNotNullString(news_url) && BasicStringUtil.isNotNullString(news_class))
				initData();
		}
		...
		new Thread(new Runnable()
		{
			...
			public void run()
			{
				...
				try
				{
					...
					msg2.what = 2;
					msg2.obj = new WebImgText("<img src=\"" + news_pic + "\"/>").getCharSequence();
