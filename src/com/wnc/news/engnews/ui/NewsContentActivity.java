...
public class NewsContentActivity extends Activity implements CtrlableHorGestureDetectorListener, UncaughtExceptionHandler, OnClickListener
{
	...
	private void initView()
	{
		newsMenuPopWindow = new NewsMenuPopWindow(this, new NewsMenuListener()
		{
			...
			public void toSrcPage()
			{
				if (news_info != null)
				{
					ActivityMgr.gotoIE(NewsContentActivity.this, news_info.getUrl());
				}
			}
		...
		wordMenuPopWindow = new WordMenuPopWindow(this, new WordMenuListener()
		{
			...
			public void toNet()
			{
				ActivityMgr.gotoIE(NewsContentActivity.this, WebUrlHelper.getWordUrl(getCurrentWord()));
			}
			...
			public void doExpand()
			{
				...
				final Dialog dialog = new Dialog(NewsContentActivity.this, R.style.CustomDialogStyle);
				dialog.setContentView(R.layout.topic_tip_wdailog);
				dialog.setCanceledOnTouchOutside(true);
				Window window = dialog.getWindow();

				WindowManager.LayoutParams lp = window.getAttributes();
				lp.width = (int) (0.85 * BasicPhoneUtil.getScreenWidth(NewsContentActivity.this));
				lp.height = (int) (0.85 * BasicPhoneUtil.getScreenHeight(NewsContentActivity.this));
		...
		sectionPopWindow = new SectionPopWindow(this, new WordSectionListener()
		{
			...
			{
				ActivityMgr.gotoIE(NewsContentActivity.this, WebUrlHelper.getTranslateUrl(getCurrentSectionAndSetPos()));
