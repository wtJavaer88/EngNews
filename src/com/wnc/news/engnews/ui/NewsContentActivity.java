        ...
        OnClickListener
{
    ...
    public static final int MESSAGE_ON_CONTEXT_TEXT = 1;
    public static final int MESSAGE_ON_IMG_TEXT = 2;
    public static final int MESSAGE_ON_RUNTIME_TEXT = 3;
    TextView newsImgTv;
    ...
    private void initView()
    {
        newsMenuPopWindow = new NewsMenuPopWindow(this, new NewsMenuListener()
        {
            ...
            public void doFavorite()
            {
                ...
                ActivityMgr.loveNewsRecord(NewsContentActivity.this, news_info);
            }
