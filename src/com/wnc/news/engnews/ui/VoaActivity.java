...
public class VoaActivity extends BaseVerActivity implements OnClickListener,
        UncaughtExceptionHandler, CtrlableDoubleClickGestureDetectorListener
{
    ...
    private void initView()
    {
                    ...
                    else
                    {
                        ...
                        if (wordExpand != null)
                        {
                            try
                            {
                                ...
                                OptedDictData.getWordExpandContentMap().put(
        ...
        newsMenuPopWindow = new NewsMenuPopWindow(this, new NewsMenuListener()
        {
            ...
            public void setting()
            {
                ...
                voaSettingDialog.getWindow().setContentView(
                        R.layout.voa_setting);
                if (isAutoStop)
                {
                    ((RadioButton) voaSettingDialog
                            .findViewById(R.id.rb_voa_single)).setChecked(true);
                }
                else
                {
                    ((RadioButton) voaSettingDialog
                            .findViewById(R.id.rb_voa_full)).setChecked(true);
                }
                // 根据ID找到RadioGroup实例
