...
public class SectionPopWindow extends PopupWindow implements OnClickListener
{
	...
	public SectionPopWindow(final Activity context, WordSectionListener sectionListener)
	{
		...
		conentView.findViewById(R.id.layout_section_copy).setOnClickListener(this);
