...
public class Club
{
	...
	{
		return "Club [league=" + league + ", full_name=" + full_name + ", short_name=" + short_name + ", abbreviation=" + abbreviation + ", cn_name=" + cn_name + ", club_stats_url=" + club_stats_url + ", photo=" + photo + ", club_id=" + club_id + "]";
	}
