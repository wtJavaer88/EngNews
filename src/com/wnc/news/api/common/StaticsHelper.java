...
public class StaticsHelper
{
	...
	{
		return WebSiteUtil.getBasketballInsiders().getName().equalsIgnoreCase(str) || WebSiteUtil.getRealGm().getName().equalsIgnoreCase(str) || WebSiteUtil.getSkySports().getName().equalsIgnoreCase(str) || WebSiteUtil.getSquawka().getName().equalsIgnoreCase(str)
