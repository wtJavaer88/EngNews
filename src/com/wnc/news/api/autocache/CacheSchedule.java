                ...
                for (String team : teams)
                {
                    try
                    {
                        ...
                        if (StaticsHelper.isSoccerTeam(db, team))
                        {
                            ...
                            newsCount += cache(new SkySportsTeamApi(team), 2,
                                    cetTopicCache, "SkySportsTeamApi-" + team);
                            newsCount += cache(new SquawkaTeamApi(team), 2,
        ...
        new Thread(new Runnable()
        {
            ...
            public void run()
            {
                ...
                try
                {
                    ...
                    cache(new RedditApi("arsenal"), 1, cetTopicCache,
                            "Reddit/阿森纳");
                    cache(new RedditApi("san-antonio-spurs"), 1, cetTopicCache,
                            "Reddit/马刺");
                    cache(new RedditApi("golden-state-warriors"), 1,
                            cetTopicCache, "Reddit/勇士");
