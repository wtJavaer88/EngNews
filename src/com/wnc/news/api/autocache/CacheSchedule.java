				...
				for (String team : teams)
				{
					try
					{
						...
						if (StaticsHelper.isSoccerTeam(db, team))
						{
							...
							newsCount += cache(new SkySportsTeamApi(team), 5, cetTopicCache, "SkySportsTeamApi-" + team);
							newsCount += cache(new SquawkaTeamApi(team), 3, cetTopicCache, "SquawkaTeamApi-" + team);
						}
						else
						{
