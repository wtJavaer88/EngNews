...
{
	// @Test
	public List<Zb8News> da() throws Exception
	{
	...
	public void m() throws Exception
	{
		...
		List<Zb8News> filterTeam = NewsFilter.filterTeam(NewsFilter.filterTranslated(zuqiuNewsByYearMonth), "阿森纳");
